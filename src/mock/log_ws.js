export default function mockLogWebSocket(onMessage) {
  const logs = [
    ...
    '[WEB][bots.web.bot:<module>:88][{time16_dt}][WARNING]:HTTPS is disabled. HTTP mode is insecure and should only be used in trusted environments.',
    '[WEB][core.client.init:client_init:38][{time16_dt}][INFO]:Hello, Web!',
    '[WEB][bots.web.client:lifespan:62][{time16_dt}][INFO]:',
    '---',
    'Visit AkariBot WebUI:',
    'http://127.0.0.1:6485/webui',
    '---',
    '[SERVER][core.server.run:main:28][{time16_dt}][INFO]:Stopping AkariBot Server...',
    '[SERVER][core.server.terminate:cleanup_sessions:13][{time16_dt}][WARNING]:Cleaning up sessions...',
    '[SERVER][core.database.models:clear_task:425][{time16_dt}][DEBUG]:Clearing tasks older than {time16_dt}...',
    '[SERVER][core.server.run:main:30][{time16_dt}][SUCCESS]:AkariBot Server stopped successfully.',
  ]
