export default function mockLogWebSocket(onMessage) {
  const logs = [
    '[BotDaemon][__mp_main__:pre_init:97][{time0}][INFO]:',
    '           _              _   ____        _',
    '     /\\   | |            (_) |  _ \\      | |',
    ...
    '[SERVER][core.database:fetch_module_db:28][{time3}][DEBUG]:Database list: []',
    '[SERVER][core.server.init:init_async:38][{time3}][SUCCESS]:Database initialized successfully.',
    '[SERVER][core.loader:load_modules:31][{time3}][INFO]:Attempting to load modules...',
    '[SERVER][core.loader:load_modules:58][{time3}][SUCCESS]:All modules loaded.',
    '[SERVER][core.server.init:init_async:64][{time3}][INFO]:Hello, Server!',
    '[SERVER][core.server.background_tasks:init_background_task:26][{time3}][INFO]:Starting WebRender...',
    ...
    '[BotDaemon][__main__:run_bot:275][{time16}][CRITICAL]:Process 24476 (aiocqhttp) exited with code 1, please check the log.',
    '[BotDaemon][__main__:restart_bot_process:208][{time16}][WARNING]:Restarting bot aiocqhttp...',
    '[BotDaemon][__main__:run_bot:275][{time16}][CRITICAL]:Process 24476 (aiocqhttp) exited with code 1, please check the log.',
    '[BotDaemon][__main__:restart_bot_process:208][{time16}][WARNING]:Restarting bot aiocqhttp...',
    '[BotDaemon][__main__:run_bot:275][{time16}][CRITICAL]:Process 24476 (aiocqhttp) exited with code 1, please check the log.',
    '[BotDaemon][__main__:restart_bot_process:203][{time16}][ERROR]:Bot aiocqhttp failed to start 3 times, abort to restart, please check the log.',
